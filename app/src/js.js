if (!function(t, e) {
    ...
    function l(t, e, n) {
        ...
        if (void 0 === n && 1 === t.nodeType)
            if (i = "data-" + e.replace(xe, "-$1").toLowerCase(),
            n = t.getAttribute(i),
            "string" == typeof n) {
                try {
    ...
    function x(t) {
        var e = J
          , n = Me[t];
        return n || (n = b(t, e),
        "none" !== n && n || (Re = (Re || Z("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement),
        e = Re[0].contentDocument,
        e.write(),
        e.close(),
        n = b(t, e),
        Re.detach()),
    ...
    function E(t, e, n, i, o) {
        for (var r = n === (i ? "border" : "content") ? 4 : "width" === e ? 1 : 0, s = 0; 4 > r; r += 2)
            "margin" === n && (s += Z.css(t, n + Ce[r], !0, o)),
            i ? ("content" === n && (s -= Z.css(t, "padding" + Ce[r], !0, o)),
            "margin" !== n && (s -= Z.css(t, "border" + Ce[r] + "Width", !0, o))) : (s += Z.css(t, "padding" + Ce[r], !0, o),
            "padding" !== n && (s += Z.css(t, "border" + Ce[r] + "Width", !0, o)));
        return s
    }
    function S(t, e, n) {
        var i = !0
        ...
        if (0 >= o || null == o) {
            ...
            Be.test(o))
                return o;
            i = s && (Y.boxSizingReliable() || o === t.style[e]),
            o = parseFloat(o) || 0
        }
    ...
    function $(t, e) {
        for (var n, i, o, r = [], s = 0, a = t.length; a > s; s++)
            ...
            "" === i.style.display && Te(i) && (r[s] = ve.access(i, "olddisplay", x(i.nodeName)))) : (o = Te(i),
            "none" === n && o || ve.set(i, "olddisplay", o ? n : Z.css(i, "display"))));
        for (s = 0; a > s; s++)
            i = t[s],
    ...
    function L(t, e, n) {
        var i, o, r, s, a, l, c, u, p = this, h = {}, f = t.style, d = t.nodeType && Te(t), g = ve.get(t, "fxshow");
        ...
        "inline" === u && "none" === Z.css(t, "float") && (f.display = "inline-block")),
        ...
        if (Z.isEmptyObject(h))
            ...
            g ? "hidden"in g && (d = g.hidden) : g = ve.access(t, "fxshow", {}),
            r && (g.hidden = !d),
    ...
    function q(t, e, n) {
        var i, o, r = 0, s = en.length, a = Z.Deferred().always(function() {
            delete l.elem
        }), l = function() {
            if (o)
                return !1;
            for (var e = Ye || N(), n = Math.max(0, c.startTime + c.duration - e), i = n / c.duration || 0, r = 1 - i, s = 0, l = c.tweens.length; l > s; s++)
                c.tweens[s].run(r);
    ...
    Z.extend({
        ...
        proxy: function(t, e) {
            ...
            e = t,
            t = n),
            Z.isFunction(t) ? (i = _.call(arguments, 2),
            o = function() {
    ...
    var oe = function(t) {
        function e(t, e, n, i) {
            ...
            if ((e ? e.ownerDocument || e : M) !== L && A(e),
            e = e || L,
            n = n || [],
            a = e.nodeType,
            ...
            if (!i && q) {
                    ...
                    if (s = o[1]) {
                        if (9 === a) {
                            ...
                            if (r.id === s)
                                return n.push(r),
                                n
                        } else if (e.ownerDocument && (r = e.ownerDocument.getElementById(s)) && I(e, r) && r.id === s)
                            return n.push(r),
                            n
                    } else {
                        if (o[2])
                ...
                if (w.qsa && (!P || !P.test(t))) {
                    ...
                    1 === a && "object" !== e.nodeName.toLowerCase()) {
                        for (c = E(t),
                        (p = e.getAttribute("id")) ? f = p.replace(xe, "\\$&") : e.setAttribute("id", f),
                        f = "[id='" + f + "'] ",
                        l = c.length; l--; )
                            c[l] = f + h(c[l]);
                        d = be.test(t) && u(e.parentNode) || e,
                        g = c.join(",")
                    }
                    if (g)
                        try {
        ...
        function v(t, e, n, o, r, s) {
            ...
            r && !r[R] && (r = v(r, s)),
            i(function(i, s, a, l) {
                var c, u, p, h = [], f = [], d = s.length, v = i || g(e || "*", a.nodeType ? [a] : a, []), y = !t || !i && e ? v : m(v, h, t, a, l), b = n ? r || (i ? t : d || o) ? [] : s : y;
                if (n && n(y, b, a, l),
                o)
                    for (c = m(b, f),
                    o(c, [], a, l),
                ...
                if (i) {
                    if (r || t) {
                        ...
                        for (u = b.length; u--; )
                            (p = b[u]) && (c = r ? te(i, p) : h[u]) > -1 && (i[c] = !(s[c] = p))
                    }
                } else
        ...
        function y(t) {
            for (var e, n, i, o = t.length, r = C.relative[t[0].type], s = r || C.relative[" "], a = r ? 1 : 0, l = f(function(t) {
                ...
                if (n = C.relative[t[a].type])
                    ...
                    if (n = C.filter[t[a].type].apply(null, t[a].matches),
                    n[R]) {
        ...
        function b(t, n) {
            var o = n.length > 0
              ...
              , s = function(i, s, a, l, c) {
                var u, p, h, f = 0, d = "0", g = i && [], v = [], y = D, b = i || r && C.find.TAG("*", c), x = W += null == y ? 1 : Math.random() || .1, w = b.length;
        ...
        var x, w, C, T, k, E, S, $, D, N, j, A, L, H, q, P, O, F, I, R = "sizzle" + 1 * new Date, M = t.document, W = 0, B = 0, _ = n(), z = n(), U = n(), V = function(t, e) {
            return t === e && (j = !0),
            0
        }, X = 1 << 31, Q = {}.hasOwnProperty, G = [], Y = G.pop, J = G.push, K = G.push, Z = G.slice, te = function(t, e) {
            for (var n = 0, i = t.length; i > n; n++)
                if (t[n] === e)
                    return n;
            return -1
        }, ee = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", ne = "[\\x20\\t\\r\\n\\f]", ie = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", oe = ie.replace("w", "w#"), re = "\\[" + ne + "*(" + ie + ")(?:" + ne + "*([*^$|!~]?=)" + ne + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + oe + "))|)" + ne + "*\\]", se = ":(" + ie + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + re + ")*)|.*)\\)|)", ae = new RegExp(ne + "+","g"), le = new RegExp("^" + ne + "+|((?:^|[^\\\\])(?:\\\\.)*)" + ne + "+$","g"), ce = new RegExp("^" + ne + "*," + ne + "*"), ue = new RegExp("^" + ne + "*([>+~]|" + ne + ")" + ne + "*"), pe = new RegExp("=" + ne + "*([^\\]'\"]*?)" + ne + "*\\]","g"), he = new RegExp(se), fe = new RegExp("^" + oe + "$"), de = {
            ID: new RegExp("^#(" + ie + ")"),
            CLASS: new RegExp("^\\.(" + ie + ")"),
        ...
        }, ge = /^(?:input|select|textarea|button)$/i, me = /^h\d$/i, ve = /^[^{]+\{\s*\[native \w/, ye = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, be = /[+~]/, xe = /'|\\/g, we = new RegExp("\\\\([\\da-f]{1,6}" + ne + "?|(" + ne + ")|.)","ig"), Ce = function(t, e, n) {
            var i = "0x" + e - 65536;
        ...
        A = e.setDocument = function(t) {
            ...
            O = [],
            P = [],
            (w.qsa = ve.test(i.querySelectorAll)) && (o(function(t) {
                H.appendChild(t).innerHTML = "<a id='" + R + "'></a><select id='" + R + "-\f]' msallowcapture=''><option selected=''></option></select>",
                t.querySelectorAll("[msallowcapture^='']").length && P.push("[*^$]=" + ne + "*(?:''|\"\")"),
                t.querySelectorAll("[selected]").length || P.push("\\[" + ne + "*(?:value|" + ee + ")"),
            ...
            o(function(t) {
                ...
                t.querySelectorAll("[name=d]").length && P.push("name" + ne + "*[*^$|!~]?="),
            ...
            I = e || ve.test(H.contains) ? function(t, e) {
            ...
            V = e ? function(t, e) {
                ...
                1 & n || !w.sortDetached && e.compareDocumentPosition(t) === n ? t === i || t.ownerDocument === M && I(M, t) ? -1 : e === i || e.ownerDocument === M && I(M, e) ? 1 : N ? te(N, t) - te(N, e) : 0 : 4 & n ? -1 : 1)
            }
            : function(t, e) {
                if (t === e)
                    return j = !0,
                ...
                if (!r || !a)
                    return t === i ? -1 : e === i ? 1 : r ? -1 : a ? 1 : N ? te(N, t) - te(N, e) : 0;
                if (r === a)
                    return s(t, e);
        ...
        e.matchesSelector = function(t, n) {
            ...
            n = n.replace(pe, "='$1']"),
            !(!w.matchesSelector || !q || O && O.test(n) || P && P.test(n)))
                try {
                    var i = F.call(t, n);
        ...
        C = e.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(t) {
                    var e, n = !t[6] && t[2];
                    return de.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : n && he.test(n) && (e = E(n, !0)) && (e = n.indexOf(")", n.length - e) - n.length) && (t[0] = t[0].slice(0, e),
                    t[2] = n.slice(0, e)),
                    t.slice(0, 3))
                }
            },
            filter: {
                ...
                CHILD: function(t, e, n, i, o) {
                    ...
                    : function(e, n, l) {
                        var c, u, p, h, f, d, g = r !== s ? "nextSibling" : "previousSibling", m = e.parentNode, v = a && e.nodeName.toLowerCase(), y = !l && !a;
                        if (m) {
                            if (r) {
                                for (; g; ) {
                                    for (p = e; p = p[g]; )
                            ...
                            s && y) {
                                ...
                                f = c[0] === W && c[1],
                                h = c[0] === W && c[2],
                                p = f && m.childNodes[f]; p = ++f && p && p[g] || (h = f = 0) || d.pop(); )
                                    if (1 === p.nodeType && ++h && p === e) {
                                        u[t] = [W, f, h];
                                        break
                                    }
                            } else if (y && (c = (e[R] || (e[R] = {}))[t]) && c[0] === W)
                                h = c[1];
                            else
                                for (; (p = ++f && p && p[g] || (h = f = 0) || d.pop()) && ((a ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) || !++h || (y && ((p[R] || (p[R] = {}))[t] = [W, h]),
                                p !== e)); )
                                    ;
                            return h -= o,
                            h === i || h % i === 0 && h / i >= 0
            ...
            pseudos: {
                ...
                lang: i(function(t) {
                    ...
                    function(e) {
                        var n;
                        do
                            if (n = q ? e.lang : e.getAttribute("xml:lang") || e.getAttribute("lang"))
        ...
        $ = e.select = function(t, e, n, i) {
            ...
            1 === p.length) {
                ...
                r.length > 2 && "ID" === (s = r[0]).type && w.getById && 9 === e.nodeType && q && C.relative[r[1].type]) {
                    if (e = (C.find.ID(s.matches[0].replace(we, Ce), e) || [])[0],
                    !e)
                        return n;
                    c && (e = e.parentNode),
                    t = t.slice(r.shift().value.length)
                }
                for (o = de.needsContext.test(t) ? 0 : r.length; o-- && (s = r[o],
                !C.relative[a = s.type]); )
            ...
            return (c || S(t, p))(i, e, !q, n, be.test(t) && u(e.parentNode) || e),
            n
        }
        ,
    ...
    var le, ce = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, ue = Z.fn.init = function(t, e) {
        ...
        if (!t)
            return this;
        if ("string" == typeof t) {
            if (n = "<" === t[0] && ">" === t[t.length - 1] && t.length >= 3 ? [null, t, null] : ce.exec(t),
            !n || !n[1] && e)
                return !e || e.jquery ? (e || le).find(t) : this.constructor(e).find(t);
            if (n[1]) {
                if (e = e instanceof Z ? e[0] : e,
                Z.merge(this, Z.parseHTML(n[1], e && e.nodeType ? e.ownerDocument || e : J, !0)),
                se.test(n[1]) && Z.isPlainObject(e))
                    for (n in e)
        ...
        this.length = 1,
        this) : Z.isFunction(t) ? "undefined" != typeof le.ready ? le.ready(t) : t(Z) : (void 0 !== t.selector && (this.selector = t.selector,
    ...
    Z.extend({
        ...
        when: function(t) {
            var e, n, i, o = 0, r = _.call(arguments), s = r.length, a = 1 !== s || t && Z.isFunction(t.promise) ? s : 0, l = 1 === a ? t : Z.Deferred(), c = function(t, n, i) {
                return function(o) {
                    n[t] = this,
                    i[t] = arguments.length > 1 ? _.call(arguments) : o,
    ...
    Z.extend({
        ...
        ready: function(t) {
            ...
            t !== !0 && --Z.readyWait > 0 || (ge.resolveWith(J, [Z]),
            ...
            return "object" == typeof t ? this.each(function() {
                ...
                if (r && void 0 === e) {
                    ...
                    this.each(function() {
                        var n = ye.get(this, i);
                        ye.set(this, i, e),
                        -1 !== t.indexOf("-") && void 0 !== n && ye.set(this, t, e)
                    })
    ...
    Z.extend({
        queue: function(t, e, n) {
            ...
            i = ve.get(t, e),
            n && (!i || Z.isArray(n) ? i = ve.access(t, e, Z.makeArray(n)) : i.push(n)),
            i || []) : void 0
        },
    ...
    Z.event = {
        ...
        add: function(t, e, n, i, o) {
            ...
            if (m)
                ...
                c = e.length; c--; )
                    ...
                    (h = l[f]) || (h = l[f] = [],
                    h.delegateCount = 0,
                    p.setup && p.setup.call(t, i, d, s) !== !1 || t.addEventListener && t.addEventListener(f, s, !1)),
            ...
            if (m && (l = m.events)) {
                ...
                c = e.length; c--; )
                    ...
                    f) {
                        ...
                        s && !h.length && (p.teardown && p.teardown.call(t, d, m.handle) !== !1 || Z.removeEvent(t, f, m.handle),
                        delete l[f])
                    } else
                        for (f in l)
                            Z.event.remove(t, f + e[c], n, i, !0);
                Z.isEmptyObject(l) && (delete m.handle,
                ve.remove(t, "events"))
            }
        },
        trigger: function(e, n, i, o) {
            var r, s, a, l, c, u, p, h = [i || J], f = G.call(e, "type") ? e.type : e, d = G.call(e, "namespace") ? e.namespace.split(".") : [];
            if (s = a = i = i || J,
            3 !== i.nodeType && 8 !== i.nodeType && !De.test(f + Z.event.triggered) && (f.indexOf(".") >= 0 && (d = f.split("."),
            f = d.shift(),
            d.sort()),
            c = f.indexOf(":") < 0 && "on" + f,
            e = e[Z.expando] ? e : new Z.Event(f,"object" == typeof e && e),
            e.isTrigger = o ? 2 : 3,
            e.namespace = d.join("."),
            ...
            o || !p.trigger || p.trigger.apply(i, n) !== !1)) {
                if (!o && !p.noBubble && !Z.isWindow(i)) {
                    for (l = p.delegateType || f,
                    De.test(l + f) || (s = s.parentNode); s; s = s.parentNode)
                        h.push(s),
                        a = s;
                    a === (i.ownerDocument || J) && h.push(a.defaultView || a.parentWindow || t)
                }
                for (r = 0; (s = h[r++]) && !e.isPropagationStopped(); )
                    e.type = r > 1 ? l : p.bindType || f,
                    u = (ve.get(s, "events") || {})[e.type] && ve.get(s, "handle"),
                    u && u.apply(s, n),
                    u = c && s[c],
                    u && u.apply && Z.acceptData(s) && (e.result = u.apply(s, n),
                    e.result === !1 && e.preventDefault());
                return e.type = f,
                o || e.isDefaultPrevented() || p._default && p._default.apply(h.pop(), n) !== !1 || !Z.acceptData(i) || c && Z.isFunction(i[f]) && !Z.isWindow(i) && (a = i[c],
                a && (i[c] = null),
                Z.event.triggered = f,
                i[f](),
        ...
        dispatch: function(t) {
            t = Z.event.fix(t);
            var e, n, i, o, r, s = [], a = _.call(arguments), l = (ve.get(this, "events") || {})[t.type] || [], c = Z.event.special[t.type] || {};
            if (a[0] = t,
        ...
        fix: function(t) {
            ...
            for (s || (this.fixHooks[o] = s = $e.test(o) ? this.mouseHooks : Se.test(o) ? this.keyHooks : {}),
    ...
    Z.Event = function(t, e) {
        ...
        this.type = t.type,
        this.isDefaultPrevented = t.defaultPrevented || void 0 === t.defaultPrevented && t.returnValue === !1 ? c : u) : this.type = t,
        e && Z.extend(this, e),
    ...
    Y.focusinBubbles || Z.each({
        ...
        Z.event.special[e] = {
            ...
            teardown: function() {
                var i = this.ownerDocument || this
                  , o = ve.access(i, e) - 1;
                o ? ve.access(i, e, o) : (i.removeEventListener(t, n, !0),
                ve.remove(i, e))
            }
        }
    }),
    ...
    Z.extend({
        ...
        cleanData: function(t) {
            for (var e, n, i, o, r = Z.event.special, s = 0; void 0 !== (n = t[s]); s++) {
                if (Z.acceptData(n) && (o = n[ve.expando],
                o && (e = ve.cache[o]))) {
                    if (e.events)
                        for (i in e.events)
    ...
    Z.fn.extend({
        ...
        remove: function(t, e) {
            for (var n, i = t ? Z.filter(t, this) : this, o = 0; null != (n = i[o]); o++)
                ...
                n.parentNode && (e && Z.contains(n.ownerDocument, n) && g(v(n, "script")),
        ...
        domManip: function(t, e) {
            t = z.apply([], t);
            var n, i, o, r, s, a, l = 0, c = this.length, u = this, p = c - 1, h = t[0], g = Z.isFunction(h);
            if (g || c > 1 && "string" == typeof h && !Y.checkClone && qe.test(h))
                return this.each(function(n) {
                    var i = u.eq(n);
                    g && (t[0] = h.call(this, n, i.html())),
                    i.domManip(t, e)
                });
            ...
            i)) {
                for (o = Z.map(v(n, "script"), f),
                r = o.length; c > l; l++)
                    s = n,
                    l !== p && (s = Z.clone(s, !0, !0),
                    r && Z.merge(o, v(s, "script"))),
                    e.call(this[l], s, l);
                if (r)
                    ...
                    l = 0; r > l; l++)
                        s = o[l],
                        Pe.test(s.type || "") && !ve.access(s, "globalEval") && Z.contains(a, s) && (s.src ? Z._evalUrl && Z._evalUrl(s.src) : Z.globalEval(s.textContent.replace(Fe, "")))
            }
            return this
        }
    }),
    ...
    var Re, Me = {}, We = /^margin/, Be = new RegExp("^(" + we + ")(?!px)[a-z%]+$","i"), _e = function(e) {
    ...
    Z.extend({
        ...
        style: function(t, e, n, i) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                ...
                return e = Z.cssProps[a] || (Z.cssProps[a] = T(l, a)),
                s = Z.cssHooks[e] || Z.cssHooks[a],
                void 0 === n ? s && "get"in s && void 0 !== (o = s.get(t, !1, i)) ? o : l[e] : (r = typeof n,
                "string" === r && (o = Ve.exec(n)) && (n = (o[1] + 1) * o[2] + parseFloat(Z.css(t, e)),
                r = "number"),
                void (null != n && n === n && ("number" !== r || Z.cssNumber[a] || (n += "px"),
        ...
        css: function(t, e, n, i) {
            ...
            return e = Z.cssProps[a] || (Z.cssProps[a] = T(t.style, a)),
            s = Z.cssHooks[e] || Z.cssHooks[a],
            s && "get"in s && (o = s.get(t, !0, n)),
            void 0 === o && (o = w(t, e, i)),
            "normal" === o && e in Qe && (o = Qe[e]),
            "" === n || n ? (r = parseFloat(o),
    ...
    Z.fx.step = {};
    var Ye, Je, Ke = /^(?:toggle|show|hide)$/, Ze = new RegExp("^(?:([+-])=|)(" + we + ")([a-z%]*)$","i"), tn = /queueHooks$/, en = [L], nn = {
        "*": [function(t, e) {
    ...
    Z.fn.extend({
        ...
        finish: function(t) {
            return t !== !1 && (t = t || "fx"),
            this.each(function() {
                var e, n = ve.get(this), i = n[t + "queue"], o = n[t + "queueHooks"], r = Z.timers, s = i ? i.length : 0;
                for (n.finish = !0,
                Z.queue(this, t, []),
    ...
    Z.extend({
        attr: function(t, e, n) {
            ...
            return t && 3 !== r && 8 !== r && 2 !== r ? typeof t.getAttribute === Ee ? Z.prop(t, e, n) : (1 === r && Z.isXMLDoc(t) || (e = e.toLowerCase(),
            i = Z.attrHooks[e] || (Z.expr.match.bool.test(e) ? rn : on)),
            ...
            n) : void Z.removeAttr(t, e)) : void 0
        },
    ...
    Z.extend({
        ...
        prop: function(t, e, n) {
            ...
            return t && 3 !== s && 8 !== s && 2 !== s ? (r = 1 !== s || !Z.isXMLDoc(t),
            r && (e = Z.propFix[e] || e,
            o = Z.propHooks[e]),
            void 0 !== n ? o && "set"in o && void 0 !== (i = o.set(t, n, e)) ? i : t[e] = n : o && "get"in o && null !== (i = o.get(t, e)) ? i : t[e]) : void 0
        },
        propHooks: {
            tabIndex: {
                get: function(t) {
    ...
    Z.fn.extend({
        ...
        toggleClass: function(t, e) {
            ...
            : function() {
                if ("string" === n)
                    for (var e, i = 0, o = Z(this), r = t.match(fe) || []; e = r[i++]; )
                        o.hasClass(e) ? o.removeClass(e) : o.addClass(e);
                else
                    (n === Ee || "boolean" === n) && (this.className && ve.set(this, "__className__", this.className),
        ...
        hasClass: function(t) {
            for (var e = " " + t + " ", n = 0, i = this.length; i > n; n++)
                if (1 === this[n].nodeType && (" " + this[n].className + " ").replace(ln, " ").indexOf(e) >= 0)
                    return !0;
            return !1
        }
    });
    ...
    Z.fn.extend({
        val: function(t) {
            var e, n, i, o = this[0];
            return arguments.length ? (i = Z.isFunction(t),
            ...
            })) : o ? (e = Z.valHooks[o.type] || Z.valHooks[o.nodeName.toLowerCase()],
            ...
            select: {
                get: function(t) {
                    for (var e, n, i = t.options, o = t.selectedIndex, r = "select-one" === t.type || 0 > o, s = r ? null : [], a = r ? o + 1 : i.length, l = 0 > o ? a : r ? o : 0; a > l; l++)
                        if (n = i[l],
                        !(!n.selected && l !== o || (Y.optDisabled ? n.disabled : null !== n.getAttribute("disabled")) || n.parentNode.disabled && Z.nodeName(n.parentNode, "optgroup"))) {
                            if (e = Z(n).val(),
                            r)
                                return e;
                            s.push(e)
    ...
    Z.extend({
        ...
        ajax: function(t, e) {
            function n(t, e, n, s) {
                ...
                n && (y = I(p, w, n)),
                y = R(p, y, w, l),
                l ? (p.ifModified && (x = w.getResponseHeader("Last-Modified"),
                x && (Z.lastModified[o] = x),
                x = w.getResponseHeader("etag"),
                x && (Z.etag[o] = x)),
                204 === t || "HEAD" === p.type ? C = "nocontent" : 304 === t ? C = "notmodified" : (C = y.state,
                u = y.data,
                v = y.error,
                l = !v)) : (v = C,
                (t || !C) && (C = "error",
                ...
                w.status = t,
                w.statusText = (e || C) + "",
                l ? d.resolveWith(h, [u, C, w]) : d.rejectWith(h, [w, C, v]),
                w.statusCode(m),
                m = void 0,
            ...
            t = void 0),
            e = e || {};
            var i, o, r, s, a, l, c, u, p = Z.ajaxSetup({}, e), h = p.context || p, f = p.context && (h.nodeType || h.jquery) ? Z(h) : Z.event, d = Z.Deferred(), g = Z.Callbacks("once memory"), m = p.statusCode || {}, v = {}, y = {}, b = 0, x = "canceled", w = {
                readyState: 0,
            ...
            if (d.promise(w).complete = g.add,
            w.success = w.done,
            w.error = w.fail,
            p.url = ((t || p.url || Cn) + "").replace(hn, "").replace(vn, Tn[1] + "//"),
            p.type = e.method || e.type || p.method || p.type,
            p.dataTypes = Z.trim(p.dataType || "*").toLowerCase().match(fe) || [""],
            null == p.crossDomain && (l = yn.exec(p.url.toLowerCase()),
            p.crossDomain = !(!l || l[1] === Tn[1] && l[2] === Tn[2] && (l[3] || ("http:" === l[1] ? "80" : "443")) === (Tn[3] || ("http:" === Tn[1] ? "80" : "443")))),
            ...
            delete p.data),
            p.cache === !1 && (p.url = fn.test(o) ? o.replace(fn, "$1_=" + un++) : o + (pn.test(o) ? "&" : "?") + "_=" + un++)),
            p.ifModified && (Z.lastModified[o] && w.setRequestHeader("If-Modified-Since", Z.lastModified[o]),
            ...
            if (p.beforeSend && (p.beforeSend.call(h, w, p) === !1 || 2 === b))
                return w.abort();
            x = "abort";
            for (u in {
                success: 1,
    ...
    Y.cors = !!Ln && "withCredentials"in Ln,
    Y.ajax = Ln = !!Ln,
            ...
            send: function(n, i) {
                ...
                e = function(t) {
                    return function() {
                        ...
                        "abort" === t ? r.abort() : "error" === t ? i(r.status, r.statusText) : i(An[r.status] || r.status, r.statusText, "string" == typeof r.responseText ? {
                            text: r.responseText
    ...
    Z.ajaxPrefilter("json jsonp", function(e, n, i) {
        ...
        a ? e[a] = e[a].replace(qn, "$1" + o) : e.jsonp !== !1 && (e.url += (pn.test(e.url) ? "&" : "?") + e.jsonp + "=" + o),
    ...
    Z.offset = {
        setOffset: function(t, e, n) {
            var i, o, r, s, a, l, c, u = Z.css(t, "position"), p = Z(t), h = {};
    ...
    Z.fn.extend({
        offset: function(t) {
            ...
            Z.contains(e, i) ? (typeof i.getBoundingClientRect !== Ee && (o = i.getBoundingClientRect()),
            n = W(r),
            {
        ...
        offsetParent: function() {
            return this.map(function() {
                for (var t = this.offsetParent || On; t && !Z.nodeName(t, "html") && "static" === Z.css(t, "position"); )
                    t = t.offsetParent;
                return t || On
            })
        }
    ...
    Z.each(["top", "left"], function(t, e) {
        Z.cssHooks[e] = C(Y.pixelPosition, function(t, n) {
            return n ? (n = w(t, e),
            Be.test(n) ? Z(t).position()[e] + "px" : n) : void 0
        })
    }),
    Z.each({
        Height: "height",
    ...
    return Z.noConflict = function(e) {
        return t.$ === Z && (t.$ = In),
        e && t.jQuery === Z && (t.jQuery = Fn),
        Z
    }
    ,
    typeof e === Ee && (t.jQuery = t.$ = Z),
    Z
}),
...
+function(t) {
    ...
    t(document).on("click.bs.collapse.data-api", '[data-toggle="collapse"]', function(n) {
        ...
        a && a.transitioning || (u && u.find('[data-toggle="collapse"][data-parent="' + c + '"]').not(o).addClass("collapsed"),
    ...
    n.prototype.checkPosition = function() {
        if (this.$element.is(":visible")) {
            ...
            if (this.affixed !== l) {
                ...
                this.$element.removeClass(n.RESET).addClass(c).trigger(t.Event(c.replace("affix", "affixed"))),
...
function(t) {
    ...
    t.fn.borderLayout = function() {
        ...
        return this.each(function() {
            function e() {
                c && (b = c._data.width,
                b && (b = o(b, p, c._data["min-width"], c._data["max-width"]),
                k = b,
                x = parseInt(c._data.left) || 0,
                x && (w -= x,
                k += x),
                w -= b,
                n(c, {
                ...
                l && (b = l._data.width,
                b && (b = o(b, p, l._data["min-width"], l._data["max-width"]),
                x = parseInt(l._data.right) || 0,
                x && (w -= x),
                w -= b,
                n(l, {
                    top: T,
            ...
            function i() {
                s && (b = s._data.height,
                b && (b = o(b, h, s._data["min-height"], s._data["max-height"]),
                C -= b,
                T = b,
                n(s, {
                    top: 0,
                ...
                a && (b = a._data.height,
                b && (b = o(b, h, a._data["min-height"], a._data["max-height"]),
                C -= b,
                n(a, {
                    bottom: 0,
                    left: k,
            ...
            for (var r, s, a, l, c, u = t(this).hasClass("layout--h"), p = this.clientWidth, h = this.clientHeight, f = 0, d = this.children; f < d.length; ) {
                ...
                if (m) {
                    ...
                    var y = m.region;
                    y && (g._data = m,
                    /center/i.test(y) ? r = g : /north/i.test(y) ? s = g : /south/i.test(y) ? a = g : /east/i.test(y) ? l = g : /west/i.test(y) && (c = g))
                }
            }
            var b, x, w = p, C = h, T = 0, k = 0;
            u ? (e(),
            i()) : (i(),
            e()),
            r && n(r, {
...
!function(t) {
    ...
    var e = function(t) {
        ...
        t && (void 0 !== t.toLowerCase ? (t += "",
        this.setColor(t)) : void 0 !== t.h && (this.value = t))
    };
    e.prototype = {
        constructor: e,
        colors: {
        ...
        isTransparent: function(t) {
            ...
            "transparent" == t || t.match(/#?00000000/) || t.match(/(rgba|hsla)\(0,0,0,0?\.?0\)/)) : !1
        },
        ...
        stringToHSB: function(e) {
            ...
            return t.each(this.stringParsers, function(t, o) {
                var r = o.re.exec(e)
                  ...
                  , a = o.format || "rgba";
                return s ? (i = a.match(/hsla?/) ? n.RGBtoHSB.apply(n, n.HSLtoRGB.apply(n, s)) : n.RGBtoHSB.apply(n, s),
                n.origFormat = a,
                !1) : !0
            }),
            i
    ...
    var n = {
      ...
      , i = function(i, o) {
        ...
        this.options = t.extend({}, n, this.element.data(), o),
    ...
    i.prototype = {
        ...
        show: function(e) {
            ...
            e.preventDefault()),
            this.options.inline === !1 && t(window.document).on({
        ...
        updatePicker: function(t) {
            ...
            return 0 !== i.length ? (this.options.horizontal === !1 ? (n = this.options.sliders,
            i.eq(1).css("top", n.hue.maxTop * (1 - this.color.value.h)).end().eq(2).css("top", n.alpha.maxTop * (1 - this.color.value.a))) : (n = this.options.slidersHorz,
            i.eq(1).css("left", n.hue.maxLeft * (1 - this.color.value.h)).end().eq(2).css("left", n.alpha.maxLeft * (1 - this.color.value.a))),
            i.eq(0).css({
        ...
        updateComponent: function(t) {
            if (t = t || this.color.toString(this.format),
            this.component !== !1) {
        ...
        update: function(t) {
            var e;
            return (this.getValue(!1) !== !1 || t === !0) && (e = this.updateComponent(),
            this.updateInput(e),
            this.updateData(e),
            this.updatePicker()),
            e
        ...
        mousedown: function(e) {
            ...
            if (!i.is(".colorpicker")) {
                if (i.is(".colorpicker-saturation"))
                    this.currentSlider = t.extend({}, o.saturation);
                else if (i.is(".colorpicker-hue"))
                    this.currentSlider = t.extend({}, o.hue);
                else {
        ...
        mousemove: function(t) {
            t.pageX || t.pageY || !t.originalEvent || (t.pageX = t.originalEvent.touches[0].pageX,
