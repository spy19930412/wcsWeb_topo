        ...
        var s = {}
          ...
          , u = function() {
            h.addEventListener("mousemove", function(e) {
                if (s.target) {
                    ...
                    if (!s.dragElement) {
                        var i = s.target;
                        if (Math.abs(n.x - s.dragPoint.x) <= 5 || Math.abs(n.y - s.dragPoint.y) <= 5)
                            return;
                        var o = document.createElement("div");
                        o.style.position = "absolute",
                        o.style.zIndex = 1e4;
                        var r = i.cloneNode(!0);
                        /canvas/i.test(r.tagName) ? r.getContext("2d").drawImage(i, 0, 0) : (o.style.maxWidth = "30px",
                        o.style.maxWidth = "30px",
                        o.style.cursor = "move"),
                        r.id = null,
                        o.appendChild(r),
                        h.appendChild(o),
            ...
            h.addEventListener("mouseup", function(t) {
                if (s.target) {
                    delete s.dragPoint,
                    delete s.target,
                    s.dragElement && (h.removeChild(s.dragElement),
                    delete s.dragElement);
                    for (var e = l(t), n = document.getElementsByClassName("Q-CanvasPanel"), i = 0; i < n.length; ) {
                        var o = n[i];
                        ++i;
                        var r = p(o);
                        if (c(r, e)) {
                            o.ondrop instanceof Function && (t.dataTransfer = s.dataTransfer,
                            o.ondrop(t));
                            break
                        }
                    }
          ...
          , d = function(t) {
            for (var e = 0, n = 0; t.offsetParent; )
                e += t.clientLeft + t.offsetLeft - t.scrollLeft,
    ...
    var e = e || "undefined" != typeof navigator && navigator.msSaveOrOpenBlob && navigator.msSaveOrOpenBlob.bind(navigator) || function(t) {
        ...
        if ("undefined" == typeof navigator || !/MSIE [1-9]\./.test(navigator.userAgent)) {
            var e = t.document
              ...
              , f = function(e, l) {
                var c, f, g, m = this, v = e.type, y = !1, _ = function() {
                    p(m, "writestart progress write writeend".split(" "))
                }, b = function() {
                    if ((y || !c) && (c = n().createObjectURL(e)),
                    f)
                        f.location.href = c;
                    else {
                ...
                l || (l = "download"),
                o ? (c = n().createObjectURL(e),
                i.href = c,
                i.download = l,
                r(i),
                m.readyState = m.DONE,
                _(),
                void d(c)) : (t.chrome && v && v !== h && (g = e.slice || e.webkitSlice,
                e = g.call(e, 0, e.size, h),
                y = !0),
                a && "download" !== l && (l += ".download"),
                (v === h || a) && (f = t),
                s ? (u += e.size,
                void s(t.TEMPORARY, u, S(function(t) {
...
!function(t) {
    function e(e, n, i) {
        ...
        if (t.isString(n)) {
            ...
            if (!r.test(o))
                return void alert("Please selects ." + n + " file")
        } else
...
!function(t, e) {
    ...
    function r(t, e, n) {
        if (t._classPath = e,
        t instanceof Function && (t.prototype._className = t._classPath,
        t.prototype._class = t),
        n !== !1)
            for (var i in t)
    ...
    function d(t) {
        var e = t.indexOf(".");
        return 0 > e ? parseFloat(t) : (t = t.substring(0, e) + "." + t.substring(e).replace(/\./g, ""),
        parseFloat(t))
    }
    if (!t.Graph.prototype.parseJSON) {
        n.prototype = {
            ...
            toJSON: function(t) {
                if (!(t instanceof Object))
                    return t;
                if (t instanceof Function && !t._classPath)
                    return null;
                if (void 0 !== t._refId)
                    return t._refed = !0,
                    {
            ...
            _parseJSON: function(t) {
                if (t._classPath)
                    return o(t._classPath);
                if (t._className) {
                    var e = o(t._className)
                      , n = new e;
                    if (void 0 !== t._refId && (this._refs[t._refId] = n),
                    n && t.json)
                        if (t = t.json,
                        n.parseJSON)
                            n.parseJSON(t, this);
        ...
        t.BaseUI.prototype.toJSON = function(t) {
            ...
            for (var n in this)
                if ("_" != n[0] && ("$" != n[0] || "_" != n[1]) && 0 != n.indexOf("$invalidate") && f[n] !== !1) {
                    var i = this[n];
                    if (!(i instanceof Function || i == this["class"].prototype[n]))
                        try {
                            e[n] = t.toJSON(i)
                        } catch (o) {}
                }
        ...
        t.Element.prototype.toJSON = function(t) {
            var e = {}
              , n = g;
            if (this.outputProperties && (n = n.concat(this.outputProperties)),
            l(t, n, e, this),
            this.styles) {
        ...
        t.Element.prototype.parseJSON = function(t, e) {
            if (t.styles) {
                ...
                for (var i in t.styles)
                    n[i] = e.parseJSON(t.styles[i]);
                this.putStyles(n, !0)
            }
            if (t.properties) {
                var o = {};
                for (var i in t.properties)
                    o[i] = e.parseJSON(t.properties[i]);
                this.properties = o
            }
        ...
        u.prototype = {
            ...
            clearRef: function() {
                for (var t in this._globalRefs)
                    delete this._globalRefs[t]._value;
                for (var t in this._refValues)
                    delete this._refValues[t]._refId;
                this.reset()
            },
            ...
            toJSON: function(e) {
                if (!(e instanceof Object))
                    return e;
                if (e instanceof Function && !e._classPath)
                    return null;
                if (!this.withGlobalRefs)
                    return this._toJSON(e);
                if (e instanceof t.Element)
                    return this._elementRefs[e.id] = !0,
                    {
                        _ref: e.id
                    };
                if (void 0 === e._refId) {
            ...
            _parseJSON: function(e) {
                if (!(e instanceof Object))
                    return e;
                if (e._classPath)
                    return o(e._classPath);
                if (e._className) {
                    var n = o(e._className)
                      , i = new n;
                    if (this.withGlobalRefs && void 0 !== e._refId && (this._refs[e._refId] = i),
                    i && e.json)
                        if (e = e.json,
                        i.parseJSON)
                            i.parseJSON(e, this);
        ...
        t.Graph.prototype.parseJSON = function(e, n) {
            ...
            var i = e.scale;
            i && (this.originAtCenter = !1,
            this.translateTo(e.tx || 0, e.ty || 0, i))
        }
        ,
        r(t, "Q"),
        t.loadClassPath = r,
...
function(t, e) {
        ...
        var o = function(t) {
          ...
          , a = function(t) {
            ...
            if (e) {
                ...
                if (o.src = e.data,
                i.body.style.textAlign = "center",
                i.body.style.margin = "0px",
    ...
    n.prototype = {
        ...
        ondblclick: function() {
            return this._bounds.equals(this.wholeBounds) ? (this.oldBounds || (this.oldBounds = this.wholeBounds.clone().grow(-this.wholeBounds.height / 5, -this.wholeBounds.width / 5)),
            void this._setBounds(this.oldBounds, !0)) : void this._setBounds(this.wholeBounds.clone(), !0)
        },
        ...
        ondrag: function(e) {
            if (this.dragItem) {
                ...
                var n = e.dx
                  , i = e.dy;
                if ("border" == this.dragItem.type)
                    this._bounds.offset(n, i),
                    this._setBounds(this._bounds, !0);
                else if ("handle" == this.dragItem.type) {
                    var o = this.dragItem.name;
                    "l" == o[0] ? (this._bounds.x += n,
                    this._bounds.width -= n) : "r" == o[0] && (this._bounds.width += n),
                    "t" == o[o.length - 1] ? (this._bounds.y += i,
                    this._bounds.height -= i) : "b" == o[o.length - 1] && (this._bounds.height += i),
                    this._setBounds(this._bounds, !0)
                }
            }
        },
        enddrag: function() {
            this.dragItem && (this.dragItem = !1,
            this._bounds.width < 0 ? (this._bounds.x += this._bounds.width,
            this._bounds.width = -this._bounds.width) : 0 == this._bounds.width && (this._bounds.width = 1),
            this._bounds.height < 0 ? (this._bounds.y += this._bounds.height,
            this._bounds.height = -this._bounds.height) : 0 == this._bounds.height && (this._bounds.height = 1),
            this._bounds.width > this.wholeBounds.width && (this._bounds.width = this.wholeBounds.width),
            this._bounds.height > this.wholeBounds.height && (this._bounds.height = this.wholeBounds.height),
            this._bounds.x < 0 && (this._bounds.x = 0),
            this._bounds.y < 0 && (this._bounds.y = 0),
            this._bounds.right > this.wholeBounds.width && (this._bounds.x -= this._bounds.right - this.wholeBounds.width),
            this._bounds.bottom > this.wholeBounds.height && (this._bounds.y -= this._bounds.bottom - this.wholeBounds.height),
            this._setBounds(this._bounds, !0))
        },
    ...
    i.prototype = {
        ...
        initCanvas: function() {
            ...
            e.appendChild(i),
            this.canvas = i;
            var o, r = this._getChild(".graph-export-panel__export_bounds"), a = this._getChild(".graph-export-panel__export_size"), s = function() {
                var t = this.canvas
                  , e = t.g
                  , n = t.ratio || 1;
                e.save(),
...
function(t, e) {
    ...
    function i(n, i) {
        if ("search" == n.type) {
            ...
            if (n.iconClass) {
                ...
                n.name && a.appendChild(document.createTextNode(" " + n.name));
            if (n.input = r,
            n.search) {
                var l = function() {
                    n.searchInfo = null
                  ...
                  , u = function(t) {
                    if (n.select instanceof Function && n.searchInfo && n.searchInfo.result && n.searchInfo.result.length) {
                        ...
                        if (1 == i.length)
                            return void n.select(i[0], 0);
                        void 0 === e.index ? e.index = 0 : (e.index += t ? -1 : 1,
                        e.index < 0 && (e.index += i.length),
                        e.index %= i.length),
                        n.select(i[e.index], e.index) === !1 && (n.searchInfo = null,
                        h())
                    }
                };
                r.onkeydown = function(e) {
                    ...
                    r.value = "",
                    void t.stopEvent(e)) : void (13 == e.keyCode && h(e.shiftKey))
                }
                ,
                a.onclick = function() {
                    h()
        ...
        if ("file" == n.type) {
            ...
            if (c.className = "file-input btn btn-default btn-sm btn-file",
            r.setAttribute("type", "file"),
            r.className = "btn-file",
            n.action && (r.onchange = function(t) {
                var o = e(this)
                  , r = o.get(0).files;
            ...
            n.icon) {
                ...
                n.name && c.appendChild(document.createTextNode(" " + n.name));
        ...
        if (n.type) {
            ...
            c.appendChild(a),
            n.selected && (a.setAttribute("checked", "checked"),
            "radio" == n.type && (c.className += "active"))
        } else
            var c = document.createElement("div");
        if (c.className += "btn btn-default btn-sm",
        n.icon) {
            var s = document.createElement("img");
            s.src = n.icon,
            c.appendChild(s)
    ...
    function o(o, r, a) {
        ...
        function u(t, e, n) {
            var i = s();
            i && (i.interactionMode = e.value,
            i.interactionProperties = n || e)
        }
        function c(e, o, r, a, s) {
            for (var l in e) {
                var h = e[l];
                t.isArray(h) ? (h.forEach(function(t) {
                    t.interactionMode && (t.value = t.interactionMode,
                    t.action = u)
                }),
                n(h, o, r, a, s)) : (h.interactionMode && (h.value = h.interactionMode,
                h.action = u),
                o.appendChild(i(h, r)).info = h)
            }
        }
...
!function(t, e) {
    ...
    function i(t, n) {
        t && (void 0 === n && (n = e(t).hasClass("group--closed")),
        n ? e(t).removeClass("group--closed") : e(t).addClass("group--closed"))
    }
    function o(e) {
    ...
    var h = function(t) {
        for (var n = t.target.parentNode; n && !e(n).hasClass("group"); )
            n = n.parentNode;
        i(n)
    }
      , u = function(t, e, n) {
    ...
    u.prototype = {
        ...
        loadImageBox: function(e, n) {
            if (t.isString(e) && (e = JSON.parse(e)),
            n) {
                var i = this.html.getElementsByClassName("group").item(0);
                if (i)
                    return void this.html.insertBefore(this._createGroup(e, e.prefix), i)
            }
            ...
            return a(u, function(i, a) {
                if ("_classPath" != a && "_className" != a) {
                    ...
                    if (s) {
                        var c;
                        t.isString(s) ? (c = s,
                        !t.hasImage(s) && l && (c = s = l + s)) : c = i.imageName || i.name || a || "drawable-" + this._index++,
                        ...
                        e.size && (i.properties || (i.properties = {}),
                        i.properties.size || (i.properties.size = e.size)),
                        u = c
                    } else {
                        if (!i.html)
                            return;
...
function(t) {
    ...
    r.prototype = {
        ...
        showAt: function(t, n) {
            return this.items && this.items.length ? (this._invalidateFlag && this.render(),
            this.dom.style.display = "block",
            document.body.appendChild(this.dom),
            void e(this.dom, t, n)) : !1
        },
        hide: function() {
            this.dom && this.dom.parentNode && this.dom.parentNode.removeChild(this.dom)
        },
        render: function() {
            if (this._invalidateFlag = !1,
            this.dom)
                this.dom.innerHTML = "";
            else {
                ...
                this.dom.addEventListener(e, function(e) {
                    t.stopEvent(e)
                }, !1)
            }
        ...
        renderItem: function(e) {
            ...
            if (n.setAttribute("role", "presentation"),
            e == r.Separator)
                return n.className = r.Separator,
                n.innerHTML = " ",
                n;
            if (t.isString(e))
                return n.innerHTML = '<a role="menuitem" tabindex="-1" href="#">' + this.html2Escape(e) + "</a>",
                n;
            e.selected && (n.style.backgroundPosition = "3px 5px",
            n.style.backgroundRepeat = "no-repeat",
            n.style.backgroundImage = "url('data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAAPklEQVQ4y2P4//8/AyWYYdQA7AYAAZuamlo7ED+H4naQGNEGQDX/R8PtpBjwHIsBz+lqAGVeoDgQR1MiaRgAnxW7Q0QEK0cAAAAASUVORK5CYII=')");
            var i = document.createElement("a");
            if (i.setAttribute("role", "menuitem"),
        ...
        getMenuItems: function(e, n) {
            ...
            if (n) {
                var o = n instanceof t.ShapeNode
                  , r = (n instanceof t.Group,
                !o && n instanceof t.Node,
                n instanceof t.Edge);
                if (i.push({
                ...
                r) {
                    ...
                    i.push({
                        ...
                        action: function() {
                            t.prompt(getI18NString("Input Line Width"), n.getStyle(t.Styles.EDGE_WIDTH) || t.DefaultStyles[t.Styles.EDGE_WIDTH], function(e) {
                                ...
                                n.setStyle(t.Styles.EDGE_WIDTH, e))
                            })
                        }
                    }),
                    i.push({
                    ...
                    n.parent instanceof t.Group && i.push({
    ...
    Object.defineProperties(t.Graph.prototype, {
        popupmenu: {
            ...
            set: function(t) {
                this._popupmenu != t && (this._popupmenu = t,
                this._contextmenuListener || (this._contextmenuListener = s,
                this.addCustomInteraction(this._contextmenuListener),
                this.html.oncontextmenu = function(t) {
                    o(t, this)
                }
                .bind(this)))
            }
...
!function(t) {
    ...
    function r(e, n, r) {
        ...
        n.forEach(function(e) {
            var n;
            if (e.style)
                e.propertyType = t.Consts.PROPERTY_TYPE_STYLE,
                e.name = e.style;
            else if (e.client)
                e.propertyType = t.Consts.PROPERTY_TYPE_CLIENT,
                e.name = e.client;
            else {
                if (!e.name)
                    return;
    ...
    function p(t, e) {
        ...
        if ("point" != e) {
            if ("size" != e)
                return "degree" == e ? parseInt(t) * Math.PI / 180 : t;
            var n = t.split(",");
            if (2 == n.length) {
    ...
    n.prototype = {
        createHtml: function(e) {
            ...
            this.input = n,
            this.update(),
            $(e).colorpicker().on("changeColor.colorpicker", function() {
                this.ajdusting || this.setter.call(this.scope, this)
            }
            .bind(this))
        }
    ...
    u.prototype = {
        ...
        setValue: function(e, n) {
            return this.datas && this.datas.length ? (this.adjusting = !0,
            n.type && "string" != n.type && t.isString(e) && (e = p(e, n.type)),
            this.datas.forEach(function(t) {
                var i = l(this.graph, t, n.name, n.propertyType);
                i !== e && h(e, t, n.name, n.propertyType)
            }, this),
            void (this.adjusting = !1)) : null
        },
        getValue: function(t) {
    ...
    Object.defineProperties(u.prototype, {
        datas: {
            ...
            set: function(e) {
                if (this._datas != e && (e && !t.isArray(e) && (e = [e]),
                this._datas = e,
                this.clear(),
                e.length && 1 == e.length)) {
...
GridBackground.prototype = {
    ...
    drawScales: function(t, e, n, i) {
        ...
        t.beginPath();
        var a = e.x;
        for (a = this.currentCell * Math.ceil(a / this.currentCell); a < e.right; )
            t.moveTo(a, e.y),
            t.lineTo(a, e.y + o + o),
            this.drawText(t, "" + a | 0, a, e.y + o + o, r),
            a += this.currentCell;
        var s = e.y;
        for (s = this.currentCell * Math.ceil(s / this.currentCell); s < e.bottom; )
            t.moveTo(e.x, s),
            t.lineTo(e.x + o + o, s),
...
function(t, e) {
    ...
    n.prototype = {
        ...
        createGraph: function(n) {
            ...
            o || (o = i("graph-editor__canvas", this.dom),
            o.setAttribute("data-options", 'region:"center"'));
        ...
        dropAction: function(e, n, i) {
            if (i.ondrop) {
                ...
                if (o instanceof Function)
                    return o.call(this, e, this.graph, n, i),
                    t.stopEvent(e),
                    !1
            }
        },
        createToolbar: function() {
            ...
            return t ? this.toolbar = t : (this.toolbar = t = i("graph-editor__toolbar", this.dom),
            t.setAttribute("data-options", 'region:"north", height: 40'),
            t)
        },
        ...
        createPropertyPane: function(e) {
            if (t.PropertyPane) {
                ...
                return n || (n = i("graph-editor__property", this.dom),
                n.setAttribute("data-options", "region:'east', width: '20%', right: 0, min-width: 100, max-width: '300'")),
        ...
        loadJSONFile: function(e) {
            e[0] && t.readerSingleFile(e[0], "json", function(t) {
                return t ? (this.graph.clear(),
                void this.graph.parseJSON(t)) : void alert(getI18NString("json file is empty"))
            }
            .bind(this))
        },
        ...
        loadDatas: function(e, n) {
            if (e) {
                if (t.isString(e))
                    return void t.loadJSON(e, function(t) {
    ...
    window.localStorage && (n.prototype.loadLocal = function() {
        return localStorage.graph ? (this.graph.clear(),
